...
from turn_on_chrome import turn_on_chrome_driver, turn_on_chrome_for_datalab_driver
import sys
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(531, 519)
        Dialog.setAutoFillBackground(False)
        Dialog.setStyleSheet("")
        self.ok = QtWidgets.QPushButton(Dialog)
        self.ok.setGeometry(QtCore.QRect(220, 450, 81, 41))
        font = QtGui.QFont()
        ...
        self.find.setGeometry(QtCore.QRect(80, 80, 381, 281))
        ...
        self.email_info.setGeometry(QtCore.QRect(70, 390, 81, 31))
        ...
        self.email.setGeometry(QtCore.QRect(160, 390, 301, 31))
